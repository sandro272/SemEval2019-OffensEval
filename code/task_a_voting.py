...
def bi_lstm_model(batch_size, nb_epoch, hidden_dim, num):
    ...
    model.save("weights_bi_lstm_lstm" + num + ".hdf5")
...
def bi_gru_model(batch_size, nb_epoch, hidden_dim, num):
    ...
    model.save("weights_bi_gru_lstm" + num + ".hdf5")
...
if __name__ == '__main__':
    ...
    y_pre = (bi_lstm_pre + bi_gru_pre + attention_lstm_pre + capsulnet_pre + stacked_pre)
    print("y_pre:",y_pre)
