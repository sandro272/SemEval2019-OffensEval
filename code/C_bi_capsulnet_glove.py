...
if __name__ == '__main__':
    ...
    capsule = Capsule(num_capsule=Num_capsule, dim_capsule=Dim_capsule, routings=Routings, share_weights=True, kernel_size=(3,1))(x)
    ...
    early_stopping = EarlyStopping(monitor='val_acc', patience = 22, verbose=1)
