...
def  attention_model(DROPOUT = 0.25):
    ...
    enc = Bidirectional(GRU(hidden_dim, dropout=DROPOUT, return_sequences=True))(embedded)
...
if __name__ == '__main__':
    ...
    model = KerasClassifier(build_fn=attention_model, nb_epoch = 35, batch_size = 128, verbose=1)
