...
train_subtask_a.to_csv("./train_data/train_subtask_a.tsv", index = False, sep = '\t', encoding = "utf-8")
...
train_subtask_b.to_csv("./train_data/train_subtask_b.tsv", index = False, sep = '\t', encoding = "utf-8")
...
train_subtask_c.to_csv("./train_data/train_subtask_c.tsv", index = False, sep = '\t', encoding = "utf-8")
