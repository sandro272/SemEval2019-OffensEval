...
if __name__ == '__main__':
    ...
    # model = KerasClassifier(build_fn = rank_bi_lstm_model, batch_size=256, nb_epoch=30, verbose=1)
    model = KerasClassifier(build_fn = bi_lstm_model, nb_epoch = 27, batch_size = 64,verbose=1)
    # define the grid search parameters

    # batch_size = [64, 100, 128, 256]
    # param_grid = dict(batch_size=batch_size)

    DROPOUT = [0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55]
