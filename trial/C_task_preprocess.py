...
def review_to_wordlist(review_text):
    ...
    words = nltk.TweetTokenizer(strip_handles=True, reduce_len=True).tokenize(review_text)
    # return (review_text)
    return (words)
...
if __name__ == '__main__':
    ...
    pickle_file = os.path.join('pickle', 'SemEval_train_val_test_TASK_C4.pickle3')
